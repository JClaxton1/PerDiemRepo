...
public class Expense {
    ...
    public Expense(String Name, String Date, Double Total, String ReportID, String Category, String FromAddress){
    ...
    public Expense(String Name, String Date, Double Total, String ReportID, String Category, String FromAddress, String url){
        Long tsLong = System.currentTimeMillis()/1000;
        String ts = tsLong.toString();
    ...
    public Expense(String From, String To, String Date, Double Rate, Double Distance, Double Total, String ReportID, String Category){
        Long tsLong = System.currentTimeMillis()/1000;
        String ts = tsLong.toString();
    ...
    public Expense(String From, String To, String Date, Double Rate, Double Distance, Double Total, String ReportID, String Category, String Memo){
        Long tsLong = System.currentTimeMillis()/1000;
        String ts = tsLong.toString();
